                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="primary-pills-website-settings" role="tabpanel">
                            <form id="websiteSettingForm" method="POST">
                                ...
                                <!-- Website Tag line -->
                                <div class="col-md-12 mb-3">
                                    <label for="tag_line" class="form-label">Website tag line</label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class='bx bx-globe-alt'></i></span>
                                        <input type="text" name="tag_line" class="form-control" id="tag_line"
                                            value="{{ $websiteSetting->tag_line ?? '' }}"
                                            placeholder="Website tag line">
                                    </div>
                                </div>
