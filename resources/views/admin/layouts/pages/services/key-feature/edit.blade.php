                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="service_id" class="form-select">
                                                ...
                                                @foreach ($services as $service)
                                                    <option value="{{ $service->id }}" @selected($feature->service_id == $service->id)>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="sort_order" class="form-control"
                                                value="{{ old('sort_order', $feature->sort_order) }}" placeholder="0"
                                                min="0">
                                        </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="1"
                                                    {{ old('status', $feature->status) == 1 ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="0"
                                                    {{ old('status', $feature->status) == 0 ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
                                        </div>
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'success') {
                            ...
                            toastr.success(response.message ||
                                'Key Feature updated successfully.');
                        } else {
